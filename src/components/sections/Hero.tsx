    ...
    <section className="py-12 sm:py-20 lg:py-28">
      <div className="max-w-3xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl mb-6">
          Ship SEO-perfect websites in seconds.
        </h1>
        <p className="text-xl opacity-80 mb-10 leading-relaxed max-w-2xl mx-auto">
          A Next.js template built for AI Agents like Pi and Claude. Let them handle the code, so you can focus on the product.
        </p>
